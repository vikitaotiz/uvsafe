...
const History = () => {
  return (
    <>
      <Navbar />
      <div className="antialiased bg-[#fde68a] p-10">
        <div className="relative container mx-auto px-6 flex flex-col space-y-8">
          <div className="absolute z-0 w-2 h-full  bg-white shadow-md inset-0 left-[68px] md:mx-auto md:right-0 md:left-0"></div>
          <div className="relative z-10">
            ...
            <div className="timeline-container ">
              ...
              <div className="bg-[#fb923c] text-white p-6 rounded-md shadow-md">
                <span className="font-bold text-[#ca8a04] text-sm tracking-wide">
                  2008
                </span>
